      ...
      child: InkWell(
        ...
        child: Container(
            ...
            decoration: BoxDecoration(
                ...
                boxShadow: const [
                  BoxShadow(color: Colors.blue, offset: Offset(0, -1), blurRadius: AppConstants.defaultPadding / 4),
                  BoxShadow(color: Colors.red, offset: Offset(0, 1), blurRadius: AppConstants.defaultPadding / 4),
                ]),
            child: Row(
