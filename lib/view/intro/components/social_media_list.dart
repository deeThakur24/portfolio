          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                width: 3,
                margin: const EdgeInsets.symmetric(vertical: AppConstants.defaultPadding * 0.5),
                decoration: BoxDecoration(
                    color: Colors.white, borderRadius: BorderRadius.circular(AppConstants.defaultPadding)),
              ),
