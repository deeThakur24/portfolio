  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: AnimatedContainer(
          ...
          decoration: BoxDecoration(borderRadius: BorderRadius.circular(30), color: AppConstants.bgColor),
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style:
                      Theme.of(context).textTheme.subtitle2!.copyWith(color: Colors.white, fontWeight: FontWeight.bold),
                  maxLines: 1,
